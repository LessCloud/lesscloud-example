          ...
          <div class="row">
            <div class="col-md-12" style="margin:10px 0;">
                <div class="pull-right">
                    ...
                    <el-button type="primary" icon="search" @click="openSearchForm">搜索图书</el-button>
                    <el-button type="primary" icon="edit" @click="openAddForm">添加图书</el-button>
                </div>
            </div>
            <!-- end toolbar -->

            <!-- begin add -->
            <el-dialog title="添加图书" v-model="displayAddForm" size="small" top="10%">
                <Book-form :update-item="updateItem" scene="create"></Book-form >
            </el-dialog>
            <!-- end add -->

            <!-- begin update -->
            <el-dialog title="更新图书" v-model="displayUpdateForm" size="small" top="10%">
                <Book-form :update-item="updateItem" scene="update"></Book-form >
            </el-dialog>
            <!-- end update -->

            <!-- begin search -->
            <el-dialog title="搜索图书" v-model="displaySearchForm" size="small" top="10%">
                <Book-form :update-item="updateItem" scene="search"></Book-form >
            </el-dialog>
            <!-- end search -->

            <!-- begin preview -->
            <el-dialog title="预览图书" v-model="displayDataItemPreview" size="large" top="10%">
              <pre>{{previewData}}</pre>
            ...
            <div class="col-md-12">
                <el-table :data="tableData" border style="width: 100%" v-loading="loading" element-loading-text="正在加载图书，请稍后..." @selection-change="selectedDataItem">
                <el-table-column type="selection" width="50">
                </el-table-column>
                <el-table-column fixed prop="_id" label="ObjectID" width="220">
                </el-table-column>
                <el-table-column prop="name" label="书名" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="zz" label="zz" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="price" label="价格" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="cover" label="封面" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="great" label="赞" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="author" label="作者" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="bookIntro" label="简介" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="rate" label="评级" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="isbn" label="ISBN" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="publisher" label="出版社" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="publishDate" label="出版日期" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="pageCount" label="页数" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="commentCount" label="评论统计" width="150" :show-overflow-tooltip="true"></el-table-column>
...
import BookForm from '../forms/Book.vue'
import { Table,
TableColumn,
Tooltip,
Button,
    ...
    methods:{
        ...
        fetching(){
            ...
            lcAPI.findAll(name, params).then((response)=>{
                ...
                this.$message.error('图书数据获取失败，请刷新重试');
                this.loading = false;
            })
        },
        removeItems(){
          if(this.selectedItems.length>0) {
            ...
            lcAPI.batch(container).then((response)=>{
                ...
                this.$message({message: '删除图书成功', type: 'success'});
             }).catch((response) => this.$message.error('删除图书失败') )
          }
        },
