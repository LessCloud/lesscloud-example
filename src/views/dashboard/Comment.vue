          ...
          <div class="row">
            <div class="col-md-12" style="margin:10px 0;">
                <div class="pull-right">
                    ...
                    <el-button type="primary" icon="search" @click="openSearchForm">搜索评论</el-button>
                    <el-button type="primary" icon="edit" @click="openAddForm">添加评论</el-button>
                </div>
            </div>
            <!-- end toolbar -->

            <!-- begin add -->
            <el-dialog title="添加评论" v-model="displayAddForm" size="small" top="10%">
                <Comment-form :update-item="updateItem" scene="create"></Comment-form >
            </el-dialog>
            <!-- end add -->

            <!-- begin update -->
            <el-dialog title="更新评论" v-model="displayUpdateForm" size="small" top="10%">
                <Comment-form :update-item="updateItem" scene="update"></Comment-form >
            </el-dialog>
            <!-- end update -->

            <!-- begin search -->
            <el-dialog title="搜索评论" v-model="displaySearchForm" size="small" top="10%">
                <Comment-form :update-item="updateItem" scene="search"></Comment-form >
            </el-dialog>
            <!-- end search -->

            <!-- begin preview -->
            <el-dialog title="预览评论" v-model="displayDataItemPreview" size="large" top="10%">
              <pre>{{previewData}}</pre>
            ...
            <div class="col-md-12">
                <el-table :data="tableData" border style="width: 100%" v-loading="loading" element-loading-text="正在加载评论，请稍后..." @selection-change="selectedDataItem">
                <el-table-column type="selection" width="50">
                </el-table-column>
                <el-table-column fixed prop="_id" label="ObjectID" width="220">
                </el-table-column>
                <el-table-column prop="model" label="模型" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="modelId" label="模型ID" width="150" :show-overflow-tooltip="true"></el-table-column>,<el-table-column prop="content" label="评论内容" width="150" :show-overflow-tooltip="true"></el-table-column>
    ...
    methods:{
        ...
        fetching(){
            ...
            lcAPI.findAll(name, params).then((response)=>{
                ...
                this.$message.error('评论数据获取失败，请刷新重试');
                this.loading = false;
            })
        },
        removeItems(){
          if(this.selectedItems.length>0) {
            ...
            lcAPI.batch(container).then((response)=>{
             ...
             }).catch((response) => this.$message.error('删除评论失败') )
          }
        },
